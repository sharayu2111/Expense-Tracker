 ...
 * Generated at: 2026-04-26 18:11:14 UTC
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 for(Transaction t : transactions) { 
      ...
      out.write("    </div>\n");
      out.write("\n");
      out.write("    <!-- ADVANCED PRO FEATURES SECTION -->\n");
      out.write("    <div class=\"row g-4 mb-4\">\n");
      out.write("        <div class=\"col-12 animate-fade\" style=\"animation-delay: 0.9s;\">\n");
      out.write("            <div class=\"card card-custom p-4\" style=\"background: #ffffff; color: #2d3748; border: 1px solid #e2e8f0; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);\">\n");
      out.write("                <h3 class=\"mb-4 text-primary\"><i class=\"fa-solid fa-rocket me-2\"></i>Advanced Finance Hub</h3>\n");
      out.write("                \n");
      out.write("                <div class=\"row g-4\">\n");
      out.write("                    <!-- Savings Goals -->\n");
      out.write("                    <div class=\"col-lg-4\">\n");
      out.write("                        <div class=\"p-3 border rounded h-100\" style=\"background: #f8f9fa; border-color: #e2e8f0!important;\">\n");
      out.write("                            <h5 class=\"mb-3 text-dark\"><i class=\"fa-solid fa-bullseye me-2 text-info\"></i>Savings Goals</h5>\n");
      out.write("                            ");
 if (goalsList != null && !goalsList.isEmpty()) { 
      ...
      out.write("                                    <div class=\"d-flex justify-content-between small mb-1\">\n");
      out.write("                                        <span>");
      out.print( goal.get("name") );
      out.write("</span>\n");
      out.write("                                        <span>");
      out.print( pct );
      out.write("%</span>\n");
      out.write("                                    </div>\n");
      out.write("                                    <div class=\"progress\" style=\"height: 10px; background: #e2e8f0;\">\n");
      out.write("                                        <div class=\"progress-bar bg-info\" role=\"progressbar\" style=\"width: ");
      out.print( pct );
      out.write("%;\"></div>\n");
      out.write("                                    </div>\n");
      out.write("                                    <div class=\"text-end small text-muted mt-1\">₹");
      out.print( saved );
      out.write(" / ₹");
      out.print( target );
      out.write("</div>\n");
      ...
      out.write("\n");
      out.write("                                <p class=\"text-muted small\">No active goals found.</p>\n");
      out.write("                            ");
 } 
      out.write("\n");
      out.write("                        </div>\n");
      out.write("                    </div>\n");
      out.write("                    \n");
      out.write("                    <!-- Splitwise Equivalents -->\n");
      out.write("                    <div class=\"col-lg-4\">\n");
      out.write("                        <div class=\"p-3 border rounded h-100\" style=\"background: #f8f9fa; border-color: #e2e8f0!important;\">\n");
      out.write("                            <h5 class=\"mb-3 text-dark\"><i class=\"fa-solid fa-handshake me-2 text-success\"></i>Split Expenses</h5>\n");
 ...
 if (splitsList != null && !splitsList.isEmpty()) { 
      ...
      out.write("\n");
      out.write("                                <li class=\"list-group-item bg-transparent text-dark border-light px-0\">\n");
      out.write("                                    <div class=\"fw-bold\">");
      out.print( s.get("group") );
      out.write(':');
      out.write(' ');
      out.print( s.get("desc") );
      out.write("</div>\n");
      out.write("                                    <div class=\"small text-muted\">You owe: <span class=\"text-success fw-bold\">₹");
      out.print( s.get("owe") );
      out.write("</span> (Total: ₹");
      out.print( s.get("total") );
      out.write(")</div>\n");
      out.write("                                    <form action=\"");
      out.print( request.getContextPath() );
      out.write("/dashboard\" method=\"POST\" class=\"mt-2\">\n");
      out.write("                                        <input type=\"hidden\" name=\"action\" value=\"toggleSplit\">\n");
      out.write("                                        <input type=\"hidden\" name=\"id\" value=\"");
      out.print( s.get("id") );
      out.write("\">\n");
      out.write("                                        <button type=\"submit\" class=\"btn btn-sm ");
      out.print( "PAID".equals(s.get("status")) ? "btn-outline-success" : "btn-warning" );
      out.write("\">\n");
      out.write("                                            ");
      out.print( "PAID".equals(s.get("status")) ? "🟢 PAID" : "🔴 DUE" );
      out.write("\n");
      out.write("                                        </button>\n");
      out.write("                                    </form>\n");
      out.write("                                </li>\n");
      ...
      out.write("\n");
      out.write("                                <p class=\"text-muted small\">No split expenses found.</p>\n");
      out.write("                            ");
 } 
      out.write("\n");
      out.write("                            </ul>\n");
      out.write("                            <button class=\"btn btn-sm btn-outline-success w-100 mt-3\" data-bs-toggle=\"modal\" data-bs-target=\"#addSplitModal\">+ Add Split</button>\n");
      out.write("                        </div>\n");
      out.write("                    </div>\n");
      out.write("\n");
      ...
      out.write("                    <div class=\"col-lg-4\">\n");
      out.write("                        <div class=\"p-3 border rounded h-100\" style=\"background: #f8f9fa; border-color: #e2e8f0!important;\">\n");
      out.write("                            <h5 class=\"mb-3 text-dark\"><i class=\"fa-solid fa-repeat me-2 text-warning\"></i>Subscriptions</h5>\n");
      out.write("                            <ul class=\"list-group list-group-flush\" style=\"background: transparent;\">\n");
      out.write("                            ");
 if (subsList != null && !subsList.isEmpty()) { 
      ...
      out.print( sub.get("name") );
      out.write(" <span class=\"small text-muted fw-normal\">(@");
      out.print( sub.get("due_day") );
      out.write(")</span></span>\n");
      out.write("                                        <span class=\"fw-bold\">₹");
      out.print( sub.get("cost") );
      out.write("</span>\n");
      out.write("                                    </div>\n");
      out.write("                                    <form action=\"");
      out.print( request.getContextPath() );
      out.write("/dashboard\" method=\"POST\">\n");
      out.write("                                        <input type=\"hidden\" name=\"action\" value=\"toggleSub\">\n");
      out.write("                                        <input type=\"hidden\" name=\"id\" value=\"");
      out.print( sub.get("id") );
      out.write("\">\n");
      out.write("                                        <button type=\"submit\" class=\"btn btn-sm ");
      out.print( "PAID".equals(sub.get("status")) ? "btn-outline-success" : "btn-warning" );
      out.write("\">\n");
      out.write("                                            ");
      out.print( "PAID".equals(sub.get("status")) ? "🟢 PAID" : "🔴 DUE" );
      out.write("\n");
      out.write("                                        </button>\n");
      out.write("                                    </form>\n");
      out.write("                                </li>\n");
      ...
      out.write("\n");
      out.write("                                <li class=\"list-group-item bg-transparent text-dark border-light px-0 text-end\">\n");
      out.write("                                    <strong>Monthly Total: ₹");
      out.print( totalSub );
      out.write("</strong>\n");
      out.write("                                </li>\n");
      out.write("                            ");
      ...
      out.write("\n");
      out.write("                                <p class=\"text-muted small\">No active subscriptions found.</p>\n");
      out.write("                            ");
 } 
      out.write("\n");
      out.write("                            </ul>\n");
      out.write("                            <button class=\"btn btn-sm btn-outline-warning w-100 mt-3\" data-bs-toggle=\"modal\" data-bs-target=\"#addSubModal\">+ Add Subscription</button>\n");
      out.write("                        </div>\n");
      out.write("                    </div>\n");
      out.write("                </div>\n");
      out.write("            </div>\n");
      ...
      out.write("    </div>\n");
      out.write("\n");
      out.write("    <!-- PRO MODALS -->\n");
      out.write("    <!-- Add Split Modal -->\n");
      out.write("    <div class=\"modal fade\" id=\"addSplitModal\" tabindex=\"-1\">\n");
      out.write("      <div class=\"modal-dialog\">\n");
      out.write("        <div class=\"modal-content\">\n");
      out.write("          <form action=\"");
      out.print( request.getContextPath() );
      out.write("/dashboard\" method=\"POST\">\n");
      out.write("            <input type=\"hidden\" name=\"action\" value=\"addSplit\">\n");
      out.write("            <div class=\"modal-header\"><h5 class=\"modal-title\">Log Split Expense</h5><button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"modal\"></button></div>\n");
      out.write("            <div class=\"modal-body\">\n");
      out.write("                Group Name: <input type=\"text\" name=\"group\" class=\"form-control mb-2\" required>\n");
      out.write("                Description: <input type=\"text\" name=\"desc\" class=\"form-control mb-2\" required>\n");
      out.write("                Total Bill: <input type=\"number\" name=\"total\" class=\"form-control mb-2\" required>\n");
      out.write("                Participants: <input type=\"number\" name=\"parts\" class=\"form-control mb-2\" required>\n");
      out.write("            </div>\n");
      out.write("            <div class=\"modal-footer\"><button type=\"submit\" class=\"btn btn-success w-100\">Add Split</button></div>\n");
      out.write("          </form>\n");
      out.write("        </div>\n");
      out.write("      </div>\n");
      out.write("    </div>\n");
      out.write("\n");
      out.write("    <!-- Add Sub Modal -->\n");
      out.write("    <div class=\"modal fade\" id=\"addSubModal\" tabindex=\"-1\">\n");
      out.write("      <div class=\"modal-dialog\">\n");
      out.write("        <div class=\"modal-content\">\n");
      out.write("          <form action=\"");
      out.print( request.getContextPath() );
      out.write("/dashboard\" method=\"POST\">\n");
      out.write("            <input type=\"hidden\" name=\"action\" value=\"addSub\">\n");
      out.write("            <div class=\"modal-header\"><h5 class=\"modal-title\">New Subscription</h5><button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"modal\"></button></div>\n");
      out.write("            <div class=\"modal-body\">\n");
      out.write("                Subscription Name: <input type=\"text\" name=\"name\" class=\"form-control mb-2\" required>\n");
      out.write("                Monthly Cost: <input type=\"number\" name=\"cost\" class=\"form-control mb-2\" required>\n");
      out.write("                Due Day (1-31): <input type=\"number\" name=\"day\" class=\"form-control mb-2\" required>\n");
      out.write("            </div>\n");
      out.write("            <div class=\"modal-footer\"><button type=\"submit\" class=\"btn btn-warning w-100\">Add Subscription</button></div>\n");
      out.write("          </form>\n");
      out.write("        </div>\n");
      out.write("      </div>\n");
      out.write("    </div>\n");
